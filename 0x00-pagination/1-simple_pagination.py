...
def index_range(page: int, page_size: int) -> Tuple[int, int]:
    ...
    containing start & end index corresponding to the range of
    indexes to return in a list for those paginated params
    Args:
...
class Server:
    ...
    def get_page(self, page: int = 1, page_size: int = 10) -> List[List]:
        """
        Takes 2 integer args and returns requested page from the dataset
        Args:
            page (int): required page number. must be a +ve integer
